...
void loop()
{
  ...
  Serial.print(accel_t_gyro.value.x_accel/16384.0 * 9.8, DEC);
  Serial.print(F(", "));
  Serial.print(accel_t_gyro.value.y_accel/16384.0 * 9.8, DEC);
  Serial.print(F(", "));
  Serial.print(accel_t_gyro.value.z_accel/16384.0 * 9.8, DEC);
  Serial.println(F(""));
